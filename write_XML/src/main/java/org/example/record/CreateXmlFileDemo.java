...
public class CreateXmlFileDemo {
    public static void writeXml(List<String[]> providerList, List<String[]> clmnotList, List<String[]> insureList,
        ...
        try {
            ...
            for (int i1 = 0; i1 < headerGroup.size(); i1++) {
                headerData = headerGroup.get(i1);
                ...
                for (int i = 0; i < insureList.size(); i++) {
                    ...
                    System.out.println("pd:"+processDate);
                    if(processDate.length() ==5){
                        processDate = "0"+processDate;
                    }
                    System.out.println("pd2:"+processDate);
                ...
                if(headerData[0].trim().equalsIgnoreCase("Y")){
                    Element record06 = Record06.getRecord06(doc, headerGroup);
                ...
                Element record17 = Record17.getRecord17(doc, headerGroup);
